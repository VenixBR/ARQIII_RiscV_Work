...
# Load Path File
#-----------------------------------------------------------------------------
source ${PROJECT_DIR}/Synthesis_mul/scripts/common/path.tcl
...
read_hdl -language v2001 "${HDL_DIR}/radix_multiplier.v"
...
# Constraints
#-----------------------------------------------------------------------------
read_sdc ${PROJECT_DIR}/Synthesis_mul/constraints/${HDL_NAME}.sdc
report timing -lint
