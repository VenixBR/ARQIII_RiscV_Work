...
# Generated on: Thu Oct 30 09:58:53 -03 2025 (Thu Oct 30 12:58:53 UTC 2025)
...
set logfile fv/biriscv_multiplier/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/biriscv_multiplier -revised fv_map
...
add_search_path /home/ufsm00051/claudenir.alves/cra_arq/Arquivo/biriscv_multiplier/src/core -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/ufsm00051/claudenir.alves/cra_arq/Arquivo/biriscv_multiplier/src/core/radix_multiplier.v
elaborate_design -golden -root {biriscv_multiplier} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/biriscv_multiplier/fv_map.v.gz
elaborate_design -revised -root {biriscv_multiplier}
...
#add_name_alias fv/biriscv_multiplier/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.biriscv_multiplier.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.biriscv_multiplier.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.biriscv_multiplier.rtl.fv_map.rpt
