...
# Load Path File
#-----------------------------------------------------------------------------
source ${PROJECT_DIR}/Synthesis_div/scripts/common/path.tcl
...
read_hdl -language v2001 "${HDL_DIR}/biriscv_divider.v"
...
# Constraints
#-----------------------------------------------------------------------------
read_sdc ${PROJECT_DIR}/Synthesis_div/constraints/${HDL_NAME}.sdc
report timing -lint
