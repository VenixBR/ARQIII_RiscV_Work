...
# Generated on: Sun Nov 30 12:36:55 -03 2025 (Sun Nov 30 15:36:55 UTC 2025)
...
set logfile fv/biriscv_divider/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/biriscv_divider -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/ufsm00051/claudenir.alves/cra_arq/Arquivo/biriscv_multiplier/src/core/biriscv_divider.v
elaborate_design -golden -root {biriscv_divider} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/biriscv_divider/fv_map.v.gz
elaborate_design -revised -root {biriscv_divider}
...
#add_name_alias fv/biriscv_divider/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.biriscv_divider.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.biriscv_divider.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.biriscv_divider.rtl.fv_map.rpt
