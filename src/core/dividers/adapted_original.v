...
assign inst_div_w  = (funct3_s==DIV)  ? 1'b1 : 1'b0;
assign inst_divu_w = (funct3_s==DIVU) ? 1'b1 : 1'b0;
assign inst_rem_w  = (funct3_s==REM)  ? 1'b1 : 1'b0;
assign inst_remu_w = (funct3_s==REMU) ? 1'b1 : 1'b0;

// ================================================

// Identifies whether are a division instruction
...
wire div_start_w    = opcode_valid_i & div_rem_inst_w;  // Start if it is a division instruction



// ================================================ old
wire div_complete_w = !(|q_mask_q) & div_busy_q;        //  End the operation after 32 cicles
// ================================================ new
wire div_complete_w = ((divisor_q[31:0] == 0) & div_busy_q & second_cycle_s) || (!(|q_mask_q) & div_busy_q); // End the operation when divisor=0
// ================================================ 
