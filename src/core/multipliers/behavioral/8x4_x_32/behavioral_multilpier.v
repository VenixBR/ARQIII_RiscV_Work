...
(
    ...
    assign sft_part_mult_1_s = partial_mult_s[1]<<4;
    assign sft_part_mult_2_s = partial_mult_s[2]<<8;
    assign sft_part_mult_3_s = partial_mult_s[3]<<12;
    assign sft_part_mult_4_s = partial_mult_s[4]<<16;
    assign sft_part_mult_5_s = partial_mult_s[5]<<20;
    assign sft_part_mult_6_s = partial_mult_s[6]<<24;
    assign sft_part_mult_7_s = partial_mult_s[7]<<28;

    assign mult_result_s = partial_mult_s[0] + sft_part_mult_1_s + sft_part_mult_2_s + sft_part_mult_3_s + sft_part_mult_4_s +
